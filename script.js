...
btnAll.classList.add('btn', 'btn-outline', 'btn-item', 'border-dark');
...
btnKorea.classList.add('btn', 'btn-outline', 'btn-item', 'border-dark');
btnKorea.setAttribute("type", "button");
btnContainer.appendChild(btnKorea);

let btnJapan = document.createElement("button");
btnJapan.textContent = "Japan";
btnJapan.classList.add('btn', 'btn-outline', 'btn-item', 'border-dark');
...
btnChina.classList.add('btn', 'btn-outline', 'btn-item', 'border-dark');
    ...
    if (foodCategory === "All") {
        ...
        <div class="menu-items col-md-6">
            <div class="menu-image">
                <img class="img-fluid photo" src="${food.img}" alt="">
            </div>
            <div class="menu-info">
